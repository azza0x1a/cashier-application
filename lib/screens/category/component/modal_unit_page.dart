...
class ModalUnitPage extends StatefulWidget {
  const ModalUnitPage({super.key});

  @override
  State<ModalUnitPage> createState() => _ModalUnitPageState();
}

class _ModalUnitPageState extends State<ModalUnitPage> {
  String userId = '';
  String userName = '';
  ...
  Future<void> insertInvtItemUnit(context) async {
    // Remove data for the 'counter' key.
    final prefs = await SharedPreferences.getInstance();
    showLoaderDialog(context);
    token = prefs.getString('token')!;
