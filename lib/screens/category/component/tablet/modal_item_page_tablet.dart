...
class ModalItemPageTablet extends StatefulWidget {
  const ModalItemPageTablet({super.key});

  @override
  State<ModalItemPageTablet> createState() => _ModalItemPageTabletState();
}

class _ModalItemPageTabletState extends State<ModalItemPageTablet> {
  String userId = '';
  String userName = '';
  ...
  void fetchItemUnit(context) async {
