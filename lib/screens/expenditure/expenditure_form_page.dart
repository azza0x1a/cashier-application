...
class ExpenditureFormPage extends StatefulWidget {
  const ExpenditureFormPage({super.key});

  @override
  State<ExpenditureFormPage> createState() => _ExpenditureFormPageState();
}

class _ExpenditureFormPageState extends State<ExpenditureFormPage> {
  String userName = '';
  String userId = '';
  ...
  Future<void> fetchExpenditureAccount(context) async {
  ...
  Future<void> insertExpenditure(context) async {
    // Remove data for the 'counter' key.
    final prefs = await SharedPreferences.getInstance();
    showLoaderDialog(context);
    token = prefs.getString('token')!;
