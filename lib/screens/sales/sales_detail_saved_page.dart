...
class _SalesDetailSavedPageState extends State<SalesDetailSavedPage> {
  ...
  // String ppn_percentage_total_string = '';
  // double ppn_percentage_total = 0;
  // num ppn_amount_total = 0;
  num subtotal = 0;
  num subtotalItem = 0;
  num total = 0;
  num paidAmount = 0;
  ...
  Future<void> loadSharedPreference() async {
    ...
    setState(() {
      ...
      // ppn_percentage_total = double.parse(prefs.getString('ppn_percentage_total')!);
      // ppn_amount_total = double.parse(prefs.getString('ppn_amount_total')!);
  ...
  /*changePPNPercentage(var value) {
    setState(() {
      ...
      ppn_percentage_total = double.parse(value);
      String calculateAmount =
          (subtotal * ppn_percentage_total / 100).round().toString();
      ppn_amount_total = int.parse(calculateAmount);
      _ppnAmountController.text = ppn_amount_total.toString();
      // total = subtotal - ppn_amount_total;
      total = subtotal +
          (subtotal * ppn_percentage_total / 100) -
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        setState(() {
          ...
          ppn_percentage_total_string =
              preferenceCompanyJson[0]['ppn_percentage'];
